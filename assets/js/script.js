...
async function getAboutGithub() {
    try {
        ...
        // usuário do GitHub
        const resposta = await fetch('https://api.github.com/users/alissasousadev');
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                <h2>Sobre mim</h2>
                <p>
                    Meu primeiro contato com a tecnologia surgiu da curiosidade em entender como as coisas funcionam e 
                    como poderiam funcionar melhor. Desde então, venho construindo minha trajetória no desenvolvimento web, 
                    explorando o equilíbrio entre o técnico e o criativo.</p>
                <p>
                
                <p>
                    Venho de uma trajetória ligada à educação, o que moldou minha forma de aprender e criar: aprender fazendo, 
                    testar, errar, refatorar e evoluir. Tenho interesse por projetos que conectem tecnologia, educação, arte e 
                    cultura, e acredito na tecnologia como um meio de ampliar acessos e criar soluções que façam diferença.
                </p>
...
async function getProjectsGithub() {
    try {
        ...
        //  usuário do GitHub
        const resposta = await fetch('https://api.github.com/users/alissasousadev/repos?sort=updated&per_page=6');
...
// CARROSSEL - SWIPER - INICIALIZAÇÃO
